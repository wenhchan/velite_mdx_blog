...
image: lightning_network_transport.jpg
publishedAt: 2025-05-20 17:11:00
...
The transport component of the Lightning Network and its several components are shown in the leftmost part of the network connection layer in  [Encrypted message transport in the Lightning protocol suite](#LN_protocol_encrypted_transport_highlight).

<a name="LN_protocol_encrypted_transport_highlight"></a>**Encrypted message transport in the Lightning protocol suite**

<a href="/blogs/lightning_network/mtln_1401.png" target="_blank">
<Image
  src="/blogs/lightning_network/mtln_1401.png"
  width="571"
  height="300"
  alt="Image"
  sizes="100vw"
...
As we learned in [routing](#routing), every node has a long-term
...
The structure of packets on the wire resembles the diagram in [Encrypted packet structure](#noise_encrypted_packet).

<a name="noise_encrypted_packet"></a>**Encrypted packet structure**

<Image
  src="/blogs/lightning_network/mtln_1402.png"
  width="672"
  height="495"
  alt="Image"
  sizes="100vw"
...
Of course, no security is perfect and we will see in [security_and_privacy](#security_and_privacy) that these properties can be degraded and attacked. However, the Lightning Network significantly improves upon the privacy of Bitcoin.
